  ...
  const [searchParams, setSearchParams] = useSearchParams()
    ...
    useEffect(() => {
        const fetchData = async () => {
          const hum = await fetchHumanList();
          setHumanList(hum.data);
          const tmSer = await fetchTimeSeries();
          setTimeSeries(tmSer.data);
          const pass = await fetchPassangers();
          setCurrentPassangersCount(pass.data);
        };
        fetchData();
      }, []);
    ...
    useEffect(() => {
        ...
        console.log(currentPassangersCount);
          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={4} lg={3}>
                ...
                >
                  <CurrentLoad count={currentPassangersCount}/>
                </Paper>
              </Grid>
              {/* Recent Orders */}
              <Grid item xs={12}>
                <Paper sx={{ p: 2, display: 'flex', flexDirection: 'column' }}>
                  <Registrations humanList={humanList}/>
                </Paper>
              </Grid>
            </Grid>
          </Container>
